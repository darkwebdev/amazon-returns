...
export const UI_TEXT = {
  en: {
    ...
    nonFreePattern: (cost: string, days: number) => `Non-free returns (${cost} cost) within ${days} days`,
  ...
  de: {
    ...
    nonFreePattern: (cost: string, days: number) => `Kostenpflichtige Rücksendung (${cost} Kosten) innerhalb von ${days} Tagen`,
